...
function AddCompany() {
  ...
  const handleChange = (event) => {
    ...
    console.log('company dta', companyData)
  };

  const handleSubmit = (event) => {
    event.preventDefault();
    axios.post('http://localhost:8000/playground/companies/create/', companyData)
      .then((response) => {
  ...
  return (
    <div className="container d-flex justify-content-center" >
      ...
      <Form className='' style={{ width: '40%', padding: '20px', fontSize: '10px' }}>
